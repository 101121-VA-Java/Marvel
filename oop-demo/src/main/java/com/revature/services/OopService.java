...
import com.revature.models.completedTasks;
...
//		BoringTask boring = (BoringTask) new Task();
	...
	public void doCompletedTasks() {
		completedTasks ct = new completedTasks();
		System.out.println(ct);
		ct.completedTask("Homework ");
		ct.completedTask("Eating ", "Walking the dog ");
		System.out.println("Good job!, you completed:");
		System.out.println(ct.completedTasks);	
		
	}
	public void upCasting() {
		completedTasks ct = new completedTasks();
		completedTasks ct2 = new completedTasks();
		
		Task[] tasks = { ct, ct2 };
		System.out.println(tasks[0].randomNum());
		System.out.println(tasks[1].randomNum());
